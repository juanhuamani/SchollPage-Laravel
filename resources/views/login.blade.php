		...
		<div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
			...
			<div class="space-y-6">
				<div class="">
					...
					<div>
						<button type="submit" class="w-full flex justify-center bg-purple-800  hover:bg-purple-700 text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500">Sign in
				</div>
				<div class="mt-7 text-center text-gray-300 text-xs">
					<span>Copyright © 2021-2023
